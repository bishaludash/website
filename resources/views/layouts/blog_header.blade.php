<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-md-2 pt-1">
            <a href="{{route('home')}}" class="blog-icon">
                Budash           
            </a>
        </div>
        ...
        <div class="col-md-6">
            ...
            @if (Auth::check())
            <span class="ml-4 mobile-dnone">Welcome, {{ucwords(auth()->user()->fname)}}</span> 
            
            <a href="{{route('dashboard.home')}}" class="ml-2 nav-icons"
            data-toggle="tooltip" title="Dashboard">
            <i class="ion-clipboard"></i>
        </a> 
        <a href="{{route('be.logout')}}" class="ml-2 mobile-dnone nav-icons" >
